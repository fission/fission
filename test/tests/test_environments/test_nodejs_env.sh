...
NODE_RUNTIME_IMAGE=rahulbhati/nodejs
NODE_BUILDER_IMAGE=rahulbhati/nodejs-builder
...
# fission fn create --name $fn1 --env $env_v1api --code $ROOT/test/tests/test_environments/node_src/test-case-1/helloWorld.js
...
# fission fn create --name $fn2 --env $env_v1api --code $ROOT/test/tests/test_environments/node_src/test-case-2/helloUser.js
...
# log "===== 3. test POST ====="
# fission fn create --name $fn3 --env $env_v1api --code $ROOT/test/tests/test_environments/node_src/test-case-3/wordCount.js

# fission route create --function $fn3 --url /$fn3 --method POST
# sleep 3     # Waiting for router to catch up
# body='sentence:Its a beautiful day'
# timeout 20 bash -c "test_post_route $fn3 \"$body\" '4'"

log "===== 4. test builder ====="
log "Creating package ..."
pushd $ROOT/test/tests/test_environments/node_src/test-case-4
