...
run "fission canary-config create --name canary-2 --newfunc fn1-v7 --oldfunc fn1-v6 --httptrigger route-fail --increment-step 30 --increment-interval 30s --failure-threshold 10"
