...
func WCreateCli(c *cli.Context) error {
...
func WGetCli(c *cli.Context) error {
	// TODO
	log.Fatal("Not implemented")
	return nil
}

func WUpdateCli(c *cli.Context) error {
	// TODO
	log.Fatal("Not implemented")
	return nil
}

func WDeleteCli(c *cli.Context) error {
	client := GetClient(c.GlobalString("server"))
...
func WListCli(c *cli.Context) error {
	client := GetClient(c.GlobalString("server"))
