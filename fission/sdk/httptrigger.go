...
func HtCreateCli(c *cli.Context) error {
...
func HtGetCli(c *cli.Context) error {
	return nil
}

func HtUpdateCli(c *cli.Context) error {
	client := GetClient(c.GlobalString("server"))
...
func HtDeleteCli(c *cli.Context) error {
	client := GetClient(c.GlobalString("server"))
	htName := c.String("name")
	if len(htName) == 0 {
...
func HtListCli(c *cli.Context) error {
	client := GetClient(c.GlobalString("server"))
	triggerNamespace := c.String("triggerNamespace")
