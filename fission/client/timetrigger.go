...
func TtCreateCli(c *cli.Context) error {
...
func TtGetCli(c *cli.Context) error {
	return nil
}

func TtUpdateCli(c *cli.Context) error {
	client := GetClient(c.GlobalString("server"))
...
func TtDeleteCli(c *cli.Context) error {
	client := GetClient(c.GlobalString("server"))
	ttName := c.String("name")
	if len(ttName) == 0 {
...
func TtListCli(c *cli.Context) error {
	client := GetClient(c.GlobalString("server"))
	ttNs := c.String("triggerns")
...
func TtTestCli(c *cli.Context) error {
	client := GetClient(c.GlobalString("server"))
