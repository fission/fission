...
func (a *API) EnvironmentApiList(w http.ResponseWriter, r *http.Request) {
	...
	envs, err := a.fissionClient.CoreV1().Environments(ns).List(context.Background(), metav1.ListOptions{})
	if err != nil {
...
func (a *API) EnvironmentApiCreate(w http.ResponseWriter, r *http.Request) {
	...
	enew, err := a.fissionClient.CoreV1().Environments(env.ObjectMeta.Namespace).Create(context.Background(), &env, metav1.CreateOptions{})
	if err != nil {
		a.respondWithError(w, err)
		return
	}
...
func (a *API) EnvironmentApiGet(w http.ResponseWriter, r *http.Request) {
	...
	env, err := a.fissionClient.CoreV1().Environments(ns).Get(context.Background(), name, metav1.GetOptions{})
	if err != nil {
		a.respondWithError(w, err)
		return
	}
...
func (a *API) EnvironmentApiUpdate(w http.ResponseWriter, r *http.Request) {
	...
	enew, err := a.fissionClient.CoreV1().Environments(env.ObjectMeta.Namespace).Update(context.Background(), &env, metav1.UpdateOptions{})
	if err != nil {
		a.respondWithError(w, err)
		return
	}
...
func (a *API) EnvironmentApiDelete(w http.ResponseWriter, r *http.Request) {
	...
	err := a.fissionClient.CoreV1().Environments(ns).Delete(context.Background(), name, metav1.DeleteOptions{})
	if err != nil {
		a.respondWithError(w, err)
		return
	}
