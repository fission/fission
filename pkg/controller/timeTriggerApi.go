...
func (a *API) TimeTriggerApiCreate(w http.ResponseWriter, r *http.Request) {
	...
	tnew, err := a.fissionClient.TimeTriggers(t.ObjectMeta.Namespace).Create(&t)
	if err != nil {
		a.respondWithError(w, err)
		return
	}
...
func (a *API) TimeTriggerApiGet(w http.ResponseWriter, r *http.Request) {
	...
	t, err := a.fissionClient.TimeTriggers(ns).Get(name, metav1.GetOptions{})
	if err != nil {
		a.respondWithError(w, err)
		return
	}
...
func (a *API) TimeTriggerApiUpdate(w http.ResponseWriter, r *http.Request) {
	...
	tnew, err := a.fissionClient.TimeTriggers(t.ObjectMeta.Namespace).Update(&t)
	if err != nil {
		a.respondWithError(w, err)
		return
	}
