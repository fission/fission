...
func TestFunctionApi(t *testing.T) {
	...
	_, err := g.Client().DefaultClientset.V1().Function().Get(&metav1.ObjectMeta{
		Name:      testFunc.ObjectMeta.Name,
		Namespace: testNS,
	})
	assertNotFoundFailure(err, "function")

	m, err := g.Client().DefaultClientset.V1().Function().Create(testFunc)
	panicIf(err)
	defer func() {
		err := g.Client().DefaultClientset.V1().Function().Delete(m)
		panicIf(err)
	}()

	_, err = g.Client().DefaultClientset.V1().Function().Create(testFunc)
	...
	_, err = g.Client().DefaultClientset.V1().Function().Update(testFunc)
	panicIf(err)

	testFunc.ObjectMeta.ResourceVersion = ""
	testFunc.ObjectMeta.Name = "bar"
	m2, err := g.Client().DefaultClientset.V1().Function().Create(testFunc)
	panicIf(err)
	defer func() {
		err := g.Client().DefaultClientset.V1().Function().Delete(m2)
		panicIf(err)
	}()

	funcs, err := g.Client().DefaultClientset.V1().Function().List(testNS)
	panicIf(err)
	assert(len(funcs) == 2, fmt.Sprintf("created two functions, but found %v", len(funcs)))

	funcs_url := g.Client().DefaultClientset.ServerURL() + "/v2/functions"
...
func TestHTTPTriggerApi(t *testing.T) {
	...
	_, err := g.Client().DefaultClientset.V1().HTTPTrigger().Get(&metav1.ObjectMeta{
		Name:      testTrigger.ObjectMeta.Name,
		Namespace: testNS,
	})
	assertNotFoundFailure(err, "httptrigger")

	m, err := g.Client().DefaultClientset.V1().HTTPTrigger().Create(testTrigger)
	panicIf(err)
	defer func() {
		err := g.Client().DefaultClientset.V1().HTTPTrigger().Delete(m)
		panicIf(err)
	}()

	_, err = g.Client().DefaultClientset.V1().HTTPTrigger().Create(testTrigger)
	assertNameReuseFailure(err, "httptrigger")

	tr, err := g.Client().DefaultClientset.V1().HTTPTrigger().Get(m)
	panicIf(err)
	...
	_, err = g.Client().DefaultClientset.V1().HTTPTrigger().Update(testTrigger)
	panicIf(err)
	...
	m2, err := g.Client().DefaultClientset.V1().HTTPTrigger().Create(testTrigger)
	panicIf(err)
	defer func() {
		err = g.Client().DefaultClientset.V1().HTTPTrigger().Delete(m2)
		panicIf(err)
	}()

	ts, err := g.Client().DefaultClientset.V1().HTTPTrigger().List(testNS)
	panicIf(err)
...
func TestHTTPTriggerCreateMultipleTrigger(t *testing.T) {
	...
	m, err := g.Client().DefaultClientset.V1().HTTPTrigger().Create(testTrigger)
	panicIf(err)
	defer panicIf(g.Client().DefaultClientset.V1().HTTPTrigger().Delete(m))
	...
	m2, err := g.Client().DefaultClientset.V1().HTTPTrigger().Create(testTrigger2)
...
func TestEnvironmentApi(t *testing.T) {
	...
	_, err := g.Client().DefaultClientset.V1().Environment().Get(&metav1.ObjectMeta{
		Name:      testEnv.ObjectMeta.Name,
		Namespace: testNS,
	})
	assertNotFoundFailure(err, "environment")

	m, err := g.Client().DefaultClientset.V1().Environment().Create(testEnv)
	panicIf(err)
	defer func() {
		err := g.Client().DefaultClientset.V1().Environment().Delete(m)
		panicIf(err)
	}()

	_, err = g.Client().DefaultClientset.V1().Environment().Create(testEnv)
	assertNameReuseFailure(err, "environment")

	e, err := g.Client().DefaultClientset.V1().Environment().Get(m)
	panicIf(err)
	...
	_, err = g.Client().DefaultClientset.V1().Environment().Update(testEnv)
	panicIf(err)

	testEnv.ObjectMeta.ResourceVersion = ""
	testEnv.ObjectMeta.Name = "bar"

	m2, err := g.Client().DefaultClientset.V1().Environment().Create(testEnv)
	panicIf(err)
	defer func() {
		err := g.Client().DefaultClientset.V1().Environment().Delete(m2)
		panicIf(err)
	}()

	ts, err := g.Client().DefaultClientset.V1().Environment().List(testNS)
	panicIf(err)
...
func TestWatchApi(t *testing.T) {
	...
	_, err := g.Client().DefaultClientset.V1().KubeWatcher().Get(&metav1.ObjectMeta{
		Name:      testWatch.ObjectMeta.Name,
		Namespace: testNS,
	})
	assertNotFoundFailure(err, "watch")

	m, err := g.Client().DefaultClientset.V1().KubeWatcher().Create(testWatch)
	panicIf(err)
	defer func() {
		err := g.Client().DefaultClientset.V1().KubeWatcher().Delete(m)
		panicIf(err)
	}()

	_, err = g.Client().DefaultClientset.V1().KubeWatcher().Create(testWatch)
	assertNameReuseFailure(err, "watch")

	w, err := g.Client().DefaultClientset.V1().KubeWatcher().Get(m)
	panicIf(err)
	...
	m2, err := g.Client().DefaultClientset.V1().KubeWatcher().Create(testWatch)
	panicIf(err)
	defer func() {
		err := g.Client().DefaultClientset.V1().KubeWatcher().Delete(m2)
		panicIf(err)
	}()

	ws, err := g.Client().DefaultClientset.V1().KubeWatcher().List(testNS)
	panicIf(err)
...
func TestTimeTriggerApi(t *testing.T) {
	...
	_, err := g.Client().DefaultClientset.V1().TimeTrigger().Get(&metav1.ObjectMeta{Name: testTrigger.ObjectMeta.Name})
	assertNotFoundFailure(err, "trigger")

	m, err := g.Client().DefaultClientset.V1().TimeTrigger().Create(testTrigger)
	panicIf(err)
	defer func() {
		err := g.Client().DefaultClientset.V1().TimeTrigger().Delete(m)
		panicIf(err)
	}()

	_, err = g.Client().DefaultClientset.V1().TimeTrigger().Create(testTrigger)
	assertNameReuseFailure(err, "trigger")

	tr, err := g.Client().DefaultClientset.V1().TimeTrigger().Get(m)
	panicIf(err)
	...
	_, err = g.Client().DefaultClientset.V1().TimeTrigger().Update(testTrigger)
	panicIf(err)
	...
	ts, err := g.Client().DefaultClientset.V1().TimeTrigger().List(testNS)
	panicIf(err)
