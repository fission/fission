...
func (a *API) HTTPTriggerApiList(w http.ResponseWriter, r *http.Request) {
	...
	triggers, err := a.fissionClient.CoreV1().HTTPTriggers(ns).List(context.Background(), metav1.ListOptions{})
	if err != nil {
...
func (a *API) checkHTTPTriggerDuplicates(t *fv1.HTTPTrigger) error {
	triggers, err := a.fissionClient.CoreV1().HTTPTriggers(metav1.NamespaceAll).List(context.Background(), metav1.ListOptions{})
	if err != nil {
		return err
	}
...
func (a *API) HTTPTriggerApiCreate(w http.ResponseWriter, r *http.Request) {
	...
	tnew, err := a.fissionClient.CoreV1().HTTPTriggers(t.ObjectMeta.Namespace).Create(context.Background(), &t, metav1.CreateOptions{})
	if err != nil {
		a.respondWithError(w, err)
		return
	}
...
func (a *API) HTTPTriggerApiGet(w http.ResponseWriter, r *http.Request) {
	...
	t, err := a.fissionClient.CoreV1().HTTPTriggers(ns).Get(context.Background(), name, metav1.GetOptions{})
	if err != nil {
		a.respondWithError(w, err)
		return
	}
...
func (a *API) HTTPTriggerApiUpdate(w http.ResponseWriter, r *http.Request) {
	...
	tnew, err := a.fissionClient.CoreV1().HTTPTriggers(t.ObjectMeta.Namespace).Update(context.Background(), &t, metav1.UpdateOptions{})
	if err != nil {
		a.respondWithError(w, err)
		return
	}
...
func (a *API) HTTPTriggerApiDelete(w http.ResponseWriter, r *http.Request) {
	...
	err := a.fissionClient.CoreV1().HTTPTriggers(ns).Delete(context.Background(), name, metav1.DeleteOptions{})
	if err != nil {
		a.respondWithError(w, err)
		return
	}
