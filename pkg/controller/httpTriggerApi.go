...
func (a *API) HTTPTriggerApiCreate(w http.ResponseWriter, r *http.Request) {
	...
	tnew, err := a.fissionClient.HTTPTriggers(t.ObjectMeta.Namespace).Create(&t)
	if err != nil {
		a.respondWithError(w, err)
		return
	}
...
func (a *API) HTTPTriggerApiGet(w http.ResponseWriter, r *http.Request) {
	...
	t, err := a.fissionClient.HTTPTriggers(ns).Get(name, metav1.GetOptions{})
	if err != nil {
		a.respondWithError(w, err)
		return
	}
...
func (a *API) HTTPTriggerApiUpdate(w http.ResponseWriter, r *http.Request) {
	...
	tnew, err := a.fissionClient.HTTPTriggers(t.ObjectMeta.Namespace).Update(&t)
	if err != nil {
		a.respondWithError(w, err)
		return
	}
