...
func (b *MessageQueueTriggerApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *MessageQueueTriggerApplyConfiguration) GetAPIVersion() *string {
...
func (b *MessageQueueTriggerApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
