...
type HTTPTriggerInterface interface {
	Create(ctx context.Context, hTTPTrigger *corev1.HTTPTrigger, opts metav1.CreateOptions) (*corev1.HTTPTrigger, error)
	Update(ctx context.Context, hTTPTrigger *corev1.HTTPTrigger, opts metav1.UpdateOptions) (*corev1.HTTPTrigger, error)
	// Add a +genclient:noStatus comment above the type to avoid generating UpdateStatus().
	UpdateStatus(ctx context.Context, hTTPTrigger *corev1.HTTPTrigger, opts metav1.UpdateOptions) (*corev1.HTTPTrigger, error)
	...
	Apply(ctx context.Context, hTTPTrigger *applyconfigurationcorev1.HTTPTriggerApplyConfiguration, opts metav1.ApplyOptions) (result *corev1.HTTPTrigger, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, hTTPTrigger *applyconfigurationcorev1.HTTPTriggerApplyConfiguration, opts metav1.ApplyOptions) (result *corev1.HTTPTrigger, err error)
