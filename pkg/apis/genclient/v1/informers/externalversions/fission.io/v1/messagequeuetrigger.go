	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.V1V1().MessageQueueTriggers(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.V1V1().MessageQueueTriggers(namespace).Watch(options)
			},
		},
		&fissioniov1.MessageQueueTrigger{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *_messageQueueTriggerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&fissioniov1.MessageQueueTrigger{}, f.defaultInformer)
}
