	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.V1V1().Environments(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.V1V1().Environments(namespace).Watch(options)
			},
		},
		&fissioniov1.Environment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *_environmentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&fissioniov1.Environment{}, f.defaultInformer)
}
