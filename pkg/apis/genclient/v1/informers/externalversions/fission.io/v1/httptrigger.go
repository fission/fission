	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.V1V1().HTTPTriggers(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.V1V1().HTTPTriggers(namespace).Watch(options)
			},
		},
		&fissioniov1.HTTPTrigger{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *_hTTPTriggerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&fissioniov1.HTTPTrigger{}, f.defaultInformer)
}
