...
//+kubebuilder:webhook:path=/mutate-fission-io-fission-io-v1-kuberneteswatchtrigger,mutating=true,failurePolicy=fail,sideEffects=None,groups=fission.io.fission.io,resources=kuberneteswatchtriggers,verbs=create;update,versions=v1,name=mkuberneteswatchtrigger.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-fission-io-fission-io-v1-kuberneteswatchtrigger,mutating=false,failurePolicy=fail,sideEffects=None,groups=fission.io.fission.io,resources=kuberneteswatchtriggers,verbs=create;update,versions=v1,name=vkuberneteswatchtrigger.kb.io,admissionReviewVersions=v1
