...
var map_Archive = map[string]string{
	...
	"oci":      "OCI references an OCI image holding the deployment code. Mutually exclusive with Literal and URL. Supported only on PackageSpec.Deployment; PackageSpec.Validate rejects it on Source (source archives feed the builder, which has no OCI pull path).",
}
