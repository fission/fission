...
var map_Archive = map[string]string{
	...
	"oci":      "OCI references an OCI image holding the deployment code. Mutually exclusive with Literal and URL. Consumed only on PackageSpec.Deployment; ignored on Source.",
}
