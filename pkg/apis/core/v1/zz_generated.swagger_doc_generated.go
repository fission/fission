...
var map_StateConfig = map[string]string{
	...
	"maxValueBytes": "MaxValueBytes caps a single value's size. 0 means the platform default (DefaultStateMaxValueBytes, 256KiB); the ceiling is MaxStateMaxValueBytes (4MiB). Blobs belong in object storage.",
