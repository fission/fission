...
//+kubebuilder:webhook:path=/mutate-fission-io-fission-io-v1-function,mutating=true,failurePolicy=fail,sideEffects=None,groups=fission.io.fission.io,resources=functions,verbs=create;update,versions=v1,name=mfunction.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-fission-io-fission-io-v1-function,mutating=false,failurePolicy=fail,sideEffects=None,groups=fission.io.fission.io,resources=functions,verbs=create;update,versions=v1,name=vfunction.kb.io,admissionReviewVersions=v1
