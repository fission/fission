...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BuilderRegistry) DeepCopyInto(out *BuilderRegistry) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BuilderRegistry.
func (in *BuilderRegistry) DeepCopy() *BuilderRegistry {
	if in == nil {
		return nil
	}
	out := new(BuilderRegistry)
