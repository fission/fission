...
var (
	...
	// 90 matches the CRD default (pkg/apis/core/v1/types.go): a terminating
	// pod serves through the WHOLE grace window before being killed, so this
	...
	EnvRuntimeClass           = Flag{Type: String, Name: flagkey.EnvRuntimeClass, Usage: "RuntimeClass (e.g. gvisor, kata) for this environment's runtime and builder pods; does not apply to container-image functions"}
