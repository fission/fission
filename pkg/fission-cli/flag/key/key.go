...
const (
	...
	EnvBuilderKind         = "builder-kind"
	EnvBuilderRegistry     = "builder-registry"
	EnvBuilderRegistrySec  = "builder-registry-secret"
	EnvBuilderRegistryBase = "builder-registry-base-image"
	...
	PkgOCI            = "oci"
	PkgOCIPullSecret  = "oci-pull-secret"
	PkgOCISubPath     = "oci-subpath"
	PkgOCIDigest      = "oci-digest"
	PkgOutput         = Output
	PkgStatus         = "status"
	PkgOrphan         = "orphan"
