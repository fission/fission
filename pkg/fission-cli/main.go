...
func NewCliApp() *cli.App {
	...
	fnExecutionTimeoutFlag := cli.Uint64Flag{Name: "fntimeout, ft", Value: 60, Usage: "The length of time to wait for the response. If set to zero, by default it will wait of 60s for the response."}
