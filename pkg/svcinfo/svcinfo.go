...
// chart mirrors these values in values.yaml (a drift check keeps the two in
// lockstep — see test/helm).
//
...
// Go code agrees with itself and so the drift check can compare one anchor
