...
push_all_envs() {
    ...
    push_env_image "$version" "jvm"                  "jvm-env"             "9"
    push_env_image "$version" "jvm"                  "jvm-env"             "11"
...
push_all_env_builders() {
    ...
    push_env_builder_image "$version" "jvm"        "jvm-builder"        "9"
    push_env_builder_image "$version" "jvm"        "jvm-builder"        "11"
